...
<a href=?controller=lecturer&action=home&id_l=<?php echo $lecturer->id_l;?>>หน้าแรก</a>
  <a1 href=?controller=company&action=index&id_l=<?php echo $lecturer->id_l;?>>ค้นหาสถานประกอบการ/แก้ไข</a1>
  <div class="dropdown">
...
<div class="border">
    <div class="update">
        <form method="get" action="">
            ...
            <div class ="b">
              <div class="back-btn ">
                <button type="submit"name="action"value="index">กลับ</button><br>
              </div>
              <div class="update-btn">
                <button type="submit"name="action"value="update">แก้ไข</button><br>
              </div>
            </div>
            </form>
    </div>
