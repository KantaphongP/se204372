<?php class Petition{
    ...
    public static function status($key)
    {
        $petitionList=[];
        require("connection_connect.php");
        $sql="SELECT * FROM petition natural join student natural join company natural join type WHERE status_approve = '$key' ";
        $result=$conn->query($sql);
        while($my_row=$result->fetch_assoc())
        {
            $id_p=$my_row['id_p'];
    ...
    public static function date_d($key)
    {
        $petitionList=[];
        require("connection_connect.php");
        $sql="SELECT * FROM petition natural join student natural join company natural join type WHERE date_d = '$key' ";
        $result=$conn->query($sql);
        while($my_row=$result->fetch_assoc())
        {
            $id_p=$my_row['id_p'];
...
/*
    ...
    public static function searchStudent($key,$id_s)
    {
        $petitionList=[];
        //$id_s = $_GET['id_s'];
        require("connection_connect.php");
